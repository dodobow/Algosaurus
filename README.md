...
**[Memorial Archive Edition]** BOJ에서의 소중한 여정과 치열했던 열정을 기억하기 위해 제작된 아카이빙 서비스입니다. 🌟
...
- **🏆 아카이브 프로필 카드** - BOJ에서의 기록을 기억하며
  - 확장프로그램에서 확인할 수 있는 정보들을 아카이브의 형태로 확인할 수 있습니다.
  - 간편하게 이미지로 저장이 가능하여 추억을 편하게 기억할 수 있습니다.
